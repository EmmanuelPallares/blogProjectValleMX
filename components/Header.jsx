...
const Header = ({ post }) => {
  ...
  return (
    <>
      ...
      <div className="bg-white shadow-lg rounded-lg lg:p-0   pb-12 mb-6 mt-0">
        ...
        <div className="container">
          <Link className="" href="/">
            <h1 className="text-white text-5xl text-white-700 p-6  text-center bg-green-900 hover:bg-blue-500 hover:text-red-500">
              Valle de Santiago
            </h1>
          </Link>
          <div className="container mx-auto">
            <nav className="bg:gray-800 flex justify-between items-center">
              <div className="logo p-2">ff</div>
              <div className="links">
